                              ...
                              <TableRow key={key}>
                                ...
                                <TableCell>
                                  <FormControl
                                    ...
                                    variant="standard">
                                    <InputLabel
                                      htmlFor={`key-value-edit-${frameIndex}-${key}`}>
                                      {key}
                                    </InputLabel>
                                    <Input
                                      id={`key-value-edit-${frameIndex}-${key}`}
                                      value={
                                        inputValues[frameIndex][category][
                                          key
                                        ] || ""
                                      }
                                      endAdornment={
                ...
                <Paper>
                  <ClickAwayListener onClickAway={handleClose}>
                    <MenuList
                      ...
                      <MenuItem onClick={() => onFrameAdd(title, "act")}>
                        Act
                      </MenuItem>
                      <MenuItem onClick={() => onFrameAdd(title, "fact")}>
                        Fact
                      </MenuItem>
                      <MenuItem onClick={() => onFrameAdd(title, "duty")}>
                        Duty
                      </MenuItem>
                    </MenuList>
                  </ClickAwayListener>
