...
import Orders from "@/components/data/sentences"
        ...
        <Box
          ...
          <Box flex={{ xs: "1", md: "40%" }}>
            ...
            <Typography
              ...
              way to present complex data, allowing users to monitor trends,
              make data-driven decisions, and gain a quick understanding of
              important metrics.
            </Typography>
            <Typography
              variant="body2"
              ...
              the user can more easily sort or filter through our dataset. To
              sort or filter through the dataset below, hover over the first row
              and click on the horizontal three dots.
            </Typography>
          </Box>
        </Box>
        <Grid
